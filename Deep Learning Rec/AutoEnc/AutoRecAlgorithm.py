...
class AutoRecAlgorithm(AlgoBase):
    ...
    def __init__(self, epochs=10, hiddenDim=100, learningRate=0.01, batchSize=10, sim_options={}):
    ...
    def fit(self, trainset):
        ...
        for (uid, iid, rating) in trainset.all_ratings():
            trainingMatrix[int(uid), int(iid)] = rating / 6.0
        ...
        for uiid in range(trainset.n_users):
            ...
            for itemID, rec in enumerate(recs):
                self.predictedRatings[uiid, itemID] = rec * 6.0
